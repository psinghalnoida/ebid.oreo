...
<main style="max-width:720px; padding:40px 24px;">
  ...
  <div style="display:flex; gap:16px; margin:20px 0;">
    ...
    <div style="flex:1; border:1px solid var(--line); border-radius:12px; padding:16px;">
      <p style="font-size:24px; font-weight:800; margin:0;"><?= esc($pendingPayoutHolds) ?></p>
      <p style="font-size:12px; color:var(--ink-3);">Pending Payout Holds</p>
    </div>
  </div>
  ...
  <a href="/admin/payout-holds" class="btn btn-ghost" style="margin-left:8px;">Payout Holds</a>
