...
<main style="max-width:520px; padding:60px 24px;">
  ...
  <p style="color:var(--ink-2); font-size:14px;">Choose the category that best matches your situation. Tender Auctions are excluded from this process entirely.</p>
  <form method="post" action="/sale-events/<?= esc($saleEventId) ?>/dispute"><?= csrf_field() ?>
