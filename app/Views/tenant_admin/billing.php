...
<main style="max-width:820px; padding:40px 24px;">
  ...
  <p style="font-size:12px; color:var(--ink-3);">BR-32/33: Seller-Pays Success Fees on this TSX's Trading Sessions accrue here, and are consolidated into one GST-compliant invoice per calendar month.</p>
